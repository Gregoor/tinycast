    ...
    enum Kind: String, CaseIterable, Sendable {
        ...
        var descriptor: KindDescriptor {
            ...
            case .extensionResult:
                ...
                // `false`s; its section is that of the provider's own name at render time. Lowest
                // priority because the provider has already ordered its own results; this only
                // breaks a tie that the ranker never actually sees.
                return KindDescriptor(
